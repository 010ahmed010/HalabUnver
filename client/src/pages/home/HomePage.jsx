    ...
    <div className="pt-20">
      ...
      <section className="relative min-h-[92vh] flex items-center justify-center overflow-hidden dot-bg">
        ...
        <div className="relative w-full max-w-5xl mx-auto px-6 sm:px-10 lg:px-12 text-center py-24 sm:py-32">
          ...
          {/* Sub-headline — structured to avoid orphaned words */}
          <div
            className="mx-auto mb-12 text-[#94A3B8]"
            style={{ maxWidth: '580px', direction: 'rtl' }}
          >
      ...
      {/* ─────────────── STATS ─────────────── */}
      <section className="py-16 sm:py-20 border-y border-[#1E2D45] bg-[#0F1828]/50">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 sm:gap-6">
            {STATS.map((s) => (
              <div
                key={s.label}
                className="bg-[#0F1828] rounded-2xl border border-[#1E2D45] p-5 sm:p-7 text-center hover:border-[#6366F1]/30 transition-all"
              >
      ...
      <section className="py-24 sm:py-32">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
          <div className="mb-12 sm:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-[#F1F5F9] mt-2">كل ما تحتاجه، في مكان واحد</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
            {PILLARS.map((p) => (
              <Link
                key={p.key}
                to={p.href}
                className="group rounded-3xl border border-[#1E2D45] p-7 sm:p-10 hover:border-[#6366F1]/30 hover:shadow-2xl hover:shadow-black/20 transition-all block"
              ...
              >
                ...
                <p className="text-sm sm:text-base text-[#94A3B8] leading-loose mb-5">{p.desc}</p>
                <div className="flex items-center gap-2 text-sm font-semibold pt-4 border-t border-[#1E2D45]" style={{ color: p.accent }}>
      ...
      {/* ─────────────── FEATURED OFFERS ─────────────── */}
      <section className="py-20 sm:py-28 bg-[#0F1828]/60 border-y border-[#1E2D45]">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
          <div className="mb-12">
            <span className="section-label">عروض المنصة</span>
            <h2 className="text-2xl sm:text-3xl font-black text-[#F1F5F9] mt-2">أبرز ما هو متاح الآن</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
            <div className="md:col-span-2 bg-gradient-to-br from-[#6366F1]/12 to-[#8B5CF6]/6 rounded-3xl border border-[#6366F1]/25 p-8 sm:p-10">
              <span className="inline-block text-sm font-semibold text-[#6366F1] bg-[#6366F1]/10 rounded-full px-4 py-1.5 mb-4">🎓 دورة مميزة</span>
              <h3 className="text-xl sm:text-2xl font-bold text-[#F1F5F9] mb-3">دورة MERN Stack الشاملة</h3>
              <p className="text-sm sm:text-base text-[#94A3B8] mb-7 leading-loose">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
          <div className="flex items-end justify-between mb-12">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-black text-[#F1F5F9] mt-2">آخر تحديثات المنصة</h2>
            </div>
            <Link to="/exam-hub" className="text-sm sm:text-base text-[#6366F1] hover:underline shrink-0 font-medium">عرض الكل ←</Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-[#F1F5F9] mt-2 mb-5">كل إنجاز = نقاط XP</h2>
              <p className="text-[#94A3B8] text-sm sm:text-base leading-loose mb-8">
