    ...
    <div className="pt-16 min-h-screen">
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-4xl font-black text-[#F1F5F9]">تجربة أكاديمية بلا حدود</h1>
        </div>
          ...
          <div className="bg-[#0F1828] rounded-2xl border border-[#1E2D45] p-8">
            <div className="relative h-72">
              {NODES.map(node => (
                ...
                >
                  <div className="w-20 h-20 rounded-2xl border border-[#1E2D45] bg-[#162032] flex flex-col items-center justify-center text-center cursor-pointer hover:border-[#6366F1]/50 hover:bg-[#6366F1]/10 transition-all">
                    <span className="text-2xl">{node.icon}</span>
                    <span className="text-[8px] font-medium text-[#94A3B8] mt-1">{node.label}</span>
                  </div>
                  <div className="absolute bottom-full mb-2 right-0 hidden group-hover:block bg-[#162032] border border-[#6366F1]/30 p-3 w-48 text-xs text-[#F1F5F9] z-10 rounded-xl animate-fade-up">
                    {node.desc}
                  </div>
                </div>
              ))}
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="bg-[#0F1828]/90 rounded-xl border border-[#6366F1]/30 px-5 py-3 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div>
            <h2 className="text-2xl font-black text-[#F1F5F9] mb-4">فلسفة الوصول الحر</h2>
          ...
          <div className="bg-gradient-to-br from-[#6366F1]/10 to-[#8B5CF6]/5 rounded-2xl border border-[#6366F1]/20 p-6">
            <span className="section-label">ابدأ مجاناً</span>
            <h3 className="text-xl font-bold text-[#F1F5F9] mb-3">بلا قيود</h3>
        ...
        {/* Motto */}
        <div className="bg-gradient-to-br from-[#6366F1]/10 to-[#8B5CF6]/5 rounded-3xl border border-[#6366F1]/20 p-14 text-center">
